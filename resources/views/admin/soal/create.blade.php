            ...
            <form action="{{ route('soal.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <textarea name="jawaban_a" id="jawaban_a" class="form-control" placeholder="Input Jawaban A">{!! old('jawaban_a') !!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <textarea name="jawaban_b" id="jawaban_b" class="form-control" placeholder="Input Jawaban B">{!! old('jawaban_b') !!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <textarea name="jawaban_c" id="jawaban_c" class="form-control" placeholder="Input Jawaban C">{!! old('jawaban_c') !!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <textarea name="jawaban_d" id="jawaban_d" class="form-control" placeholder="Input Jawaban D">{!! old('jawaban_d') !!}</textarea>
                        </div>
                    </div>
