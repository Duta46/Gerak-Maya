    ...
    <div class="header">
      ...
      <div class="header-box">
        <div class="title">
          ...
          <a href="simulasi.html"><button class="animated-button animate__fadeInUp animate__delay-1s">
            <span>Mulai</span>
            <span></span>
          </button> </a>
    ...
    <!-- todo About -->
     <div class="about" id="about">
        <div class="container">
            ...
            <p data-aos="zoom-in" data-aos-duration="1000">Kami adalah platfrom yang menawarkan pengalaman belajar fisika dengan memvisualisasikan gerak secara virtual yang dirancang khusus untuk memenuhi kebutuhan belajar Anda. Dengan latihan soal atau kuis yang menantang, Anda dapat menguji pemahaman Anda dan melacak kemajuan belajar Anda.</p>
        </div>
     </div>
    ...
    <div class="services" id="services">
      <div class="container">
        <div class="services-box">
          ...
          <div class="boxes">
            <div class="boxs">
              <img src="assets/img/stickman.png" alt="" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500" />
              <div class="desc" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700">
                ...
                <p>
                  Pada platform ini, kita akan melihat beberapa simulasi fisika sederhana menggunakan teknik yang disebut Verlet Integration. Dimulai dengan beberapa konsep dasar yang divisualisasikan melalui demo kecil yang menyenangkan. Simulasi sederhana ini tidak sepenuhnya sesuai dengan dunia fisik yang sebenarnya. Namun, dengan Verlet Integration akan tampak alami.
                </p>
              </div>
            </div>
            <div class="boxs">
              <div class="desc" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p>
                  Dimulai dengan Hukum gerak Newton. Hukum Newton secara garis besar mendefinisikan apa itu gaya, dan bagaimana gaya tersebut memengaruhi benda, hukum tersebut menjadi dasar bagi mekanika klasik.
                </p>
              </div>
              {{-- <img src="assets/img/newton.png" alt="" data-aos="zoom-in" data-aos-duration="1000" /> --}}
              <img src="{{ asset('assets/img/newton.png') }}" alt="" data-aos="zoom-in" data-aos-duration="1000" />
            </div>
            <div class="boxs">
              {{-- <img src="assets/img/quiz.png" alt="" data-aos="zoom-in" data-aos-duration="1000" /> --}}
              <img src="{{ asset('assets/img/quiz.png') }}" alt="" data-aos="zoom-in" data-aos-duration="1000" />
              <div class="desc" data-aos="fade-up" data-aos-duration="1000">
                <h1>
                  Kuis <br />
                  Singkat
                </h1>
                <p>Bosan dengan teori yang membosankan? Dengan visualisasi gaya dan gerak pada simulasi ini, belajar jadi lebih menyenangkan. Selesaikan kuis dan dapatkan nilai terbaikmu!.
                </p>
              </div>
            </div>
          </div>
